...
public class Service {
    ...
    private MinPriorityQueue<Node> queue;

    public Service(MinPriorityQueue<Node> minPriorityQueue) {
        this.queue = minPriorityQueue;
    }
    ...
    private void updateDistance(Node current, Node neighbor, int weight) {
        ...
        if (newDistance < neighbor.getDistance()) {
            ...
            List<Node> newPath =
                    Stream.concat(current.getShortesPath().stream(), Stream.of(current)).toList();
